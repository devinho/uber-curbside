    ...
    uglify: {
      my_target: {
        ...
        files: {
          ...
          'public/js/checkoutController.js': ['js/checkoutController.js'],
          'public/js/shoppingController.js': ['js/shoppingController.js'],
          'public/js/confirmationController.js': ['js/confirmationController.js']
        } //files
      } //my_target
    }, //uglify
    copy: {
